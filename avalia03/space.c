...
// Cria a matriz para representar o tabuleiro e retorna um ponteiro (space*)
...
// Chama generate_board para criar o space/tabuleiro. E então adiciona os aliens (enemy) nas primeiras linhas do tabuleiro.
...
// Remove todos os inimigos existentes no tabuleiro.
...
// Libera a memória alocada por generate_board.
